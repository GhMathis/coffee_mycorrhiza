...
## ------------------------------------------------------------------------------------------------------------------------------------------------------------------
1:length(model_list) %>%
  purrr::map(\(x) compute.hmsc(model_list[[x]], nfold = 5, nChains = 14,   test.run = T)) -> list_mods_crossvalidation

save(list_mods_crossvalidation,file =  "list_mods_crossvalidation_genus.RData")
# load(file = "list_mods_crossvalidation_genus.RData")
...
1:length(model_bin_list) %>%
  purrr::map(\(x) compute.hmsc(model_bin_list[[x]], nfold = 5, nChains = 14,   test.run = T)) -> list_mods_bin_crossvalidation

save(list_mods_bin_crossvalidation, file = "list_mods_bin_crossvalidation_genus.RData")
