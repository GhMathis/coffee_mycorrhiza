...
Y_genus %>% 
  ...
  mutate(family = str_remove(family, "f__"),
         family = str_replace(family, "[*]", "Unknown")) -> sum_reads_genus_df
...
tree_sum_read_plot
ggsave(plot = tree_sum_read_plot, filename = "figures/genus/tree_sum_read_plot.pdf", units = "cm",height = 15, width = 28)
```
