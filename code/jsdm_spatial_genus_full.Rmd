...
wgs84_coords %>%
  ...
  left_join(altidute_df, by ="Sample_code")-> wgs84_coords
...
```{r echo=FALSE}
amf_genus_rare <- read.table("outputs/abundance_tables/Robust_MiSeq_18S_AMf_20241120_125_samples.OTU.filtered.cleaved.nosubstringOTUs.mumu.amf_genus_decont2.txt", header = TRUE, stringsAsFactors = FALSE)
...
covariate_df <- wgs84_coords %>%
  ...
  dplyr::select(Sample_code,ndvi, precip, tmax, tmin,tdelta, wind, altitude,Altitude)
...
covariate_df %>%
  ...
  rownames_to_column("Sample_code") -> covariate_standa_df
...
covariate_standa_df %>%
  select(ndvi, precip, tmin, tdelta, wind) %>%
  ggpairs(progress = F)
...
1:ncol(Y_genus) %>%
  map(\(x) glmmTMB(Y_genus[,x]~  ndvi + precip + tmin + tdelta + wind + (1|Sample_code),
                      data = covariate_standa_df,
                      #ziformula = ~1,
                      family = poisson))-> model_list #compute.glm(Y = Y_genus_temp[,x],
...
str(Y_genus)
for(i in 1:ncol(Y_genus)){
  res <- DHARMa::simulateResiduals(model_list[[i]], plot = F)
  plot(res)
  title(main = print(colnames(Y_genus)[i]))
...
Y_genus %>%
  as.data.frame() %>%
  mutate(across(names(distribution_res)[distribution_res == "poisson" |names(distribution_res) == "Viscospora (5 OTU)"], ~log1p(.x))) -> Y_genus_transform
distribution_res[failed_genus]
# distribution_res <- list(
#   "Sclerocarpum (4 OTU)" = "poisson",
#   "Glomeraceae_gen05 (4 OTU)" = "poisson",
#   "Glomeraceae_gen03 (4 OTU)" = "poisson",
#   "Glomeraceae_gen27 (6 OTU)" = "nbinom1",
#   "Rhizoglomus (31 OTU)" = "nbinom1",
#   "Silvaspora (10 OTU)" = "poisson",
#   "Sclerocystis (52 OTU)" = "nbinom1", # zif
#   "Nanoglomus (128 OTU)" = "nbinom1",
#   "Glomeraceae_gen11 (7 OTU)" = "poisson",
#   "Dominikia (43 OTU)" = "nbinom1" ,
#   "Glomeraceae_gen14 (4 OTU)" = "poisson",
#   "Microdominikia (11 OTU)" = "poisson",
#   "Septoglomus (16 OTU)" = "nbinom1", #zif
#   "Viscospora (5 OTU)" = "nbinom1", # log1p
#   "Funneliformis (2 OTU)" = "poisson",
#   "Pervetustus (2 OTU)" = "poisson",
#   "Unknown Archaeosporomycetes (4 OTU)" = "poisson",
#   "Unknown cl01 (27 OTU)" = "poisson",
#   "Unknown Glomeromycota (6 OTU)" = "poisson",
#   "Paraglomus (7 OTU)" = "poisson",
#   "Entrophospora (40 OTU)" = "nbinom1" ,
#   "Diversispora (21 OTU)" = "nbinom1",
#   "Unknown Diversisporaceae (2 OTU)" = "poisson",
#   "Redeckera (13 OTU)" = "poisson",
#   "Cetraspora (3 OTU)" = "poisson",
#   "Unknown Racocetraceae (4 OTU)" = "poisson",
#   "Unknown Gigasporales (6 OTU)" = "poisson",
#   "Dentiscutata (4 OTU)" = "nbinom1",
#   "Unknown Dentiscutataceae (2 OTU)" = "poisson",
#   "Fuscutata (6 OTU)" = "poisson",
#   "Gigaspora (14 OTU)" = "nbinom1",
#   "Scutellospora (2 OTU) " = "nbinom1",
#   "Acaulospora (88 OTU)" = "nbinom1",
#   "Unknown Glomeraceae (120 OTU)" = "nbinom1"
# )
distribution_res <- list(
  "Sclerocarpum (4 OTU)" = "poisson",
  "Glomeraceae_gen05 (4 OTU)" = "poisson",
  "Glomeraceae_gen03 (4 OTU)" = "poisson",
  "Glomeraceae_gen27 (6 OTU)" = "poisson",
  "Rhizoglomus (31 OTU)" = "poisson",
  "Silvaspora (10 OTU)" = "poisson",
  "Sclerocystis (52 OTU)" = "poisson", # zif
  "Nanoglomus (128 OTU)" = "nbinom1",
  "Glomeraceae_gen11 (7 OTU)" = "poisson",
  "Dominikia (43 OTU)" = "nbinom1" ,
  "Glomeraceae_gen14 (4 OTU)" = "poisson",
  "Microdominikia (11 OTU)" = "poisson",
  "Septoglomus (16 OTU)" = "nbinom1", #zif
  "Viscospora (5 OTU)" = "poisson", # log1p
  "Funneliformis (2 OTU)" = "poisson",
  "Pervetustus (2 OTU)" = "poisson",
  "Unknown Archaeosporomycetes (4 OTU)" = "poisson",
  "Unknown cl01 (27 OTU)" = "poisson",
  "Unknown Glomeromycota (6 OTU)" = "poisson",
  "Paraglomus (7 OTU)" = "poisson",
  "Entrophospora (40 OTU)" = "poisson" ,
  "Diversispora (21 OTU)" = "poisson",
  "Unknown Diversisporaceae (2 OTU)" = "poisson",
  "Redeckera (13 OTU)" = "poisson",
  "Cetraspora (3 OTU)" = "poisson",
  "Unknown Racocetraceae (4 OTU)" = "poisson",
  "Unknown Gigasporales (6 OTU)" = "poisson",
  "Dentiscutata (4 OTU)" = "poisson",
  "Unknown Dentiscutataceae (2 OTU)" = "poisson",
  "Fuscutata (6 OTU)" = "poisson",
  "Gigaspora (14 OTU)" = "poisson",
  "Scutellospora (2 OTU)" = "poisson",
  "Acaulospora (88 OTU)" = "poisson",
  "Unknown Glomeraceae (120 OTU)" = "poisson"
)
1:ncol(Y_genus) %>%
  map(\(x) glmmTMB(Y_genus[,x]~  ndvi + precip + tmin + tdelta + wind + (1|Sample_code),
                      data = covariate_standa_df,
                      #ziformula = ~1,
                      family = distribution_res[[x]]))-> model_list #compute.glm(Y = Y_genus_temp[,x],
                   #Xdf = covariate_df, x=x)) -> model_list
# covariate_standa_df %>%
#   as.data.frame() %>%
#   select(lon, lat) %>%
...
distribution_res_hmsc <-c(
  ...
  "Silvaspora (10 OTU)" = "poisson",
  "Sclerocystis (52 OTU)" = "poisson", # zif
  "Nanoglomus (128 OTU)" = "poisson", 
  "Glomeraceae_gen11 (7 OTU)" = "poisson",
  "Dominikia (43 OTU)" = "poisson" , 
  "Glomeraceae_gen14 (4 OTU)" = "poisson", 
  "Microdominikia (11 OTU)" = "poisson",
  "Septoglomus (16 OTU)" = "poisson", #zif
  "Viscospora (5 OTU)" = "poisson", # log1p
  "Funneliformis (2 OTU)" = "poisson",
  "Pervetustus (2 OTU)" = "poisson",
  "Unknown Archaeosporomycetes (4 OTU)" = "poisson",
...
mod_pois <- Hmsc(
  ...
  XFormula = ~poly(ndvi,2) + poly(precip,2) + poly(tmin,2) + poly(tdelta,2) + poly(wind,2) + log(readscount),
...
m_converg <- sampleMcmc(
  mod_pois,
  thin = 15, samples = samples, transient = transient,
...
mod_bin <- Hmsc(
  Y = Y_genus_bin,
  XData = covariate_standa_df,
  XFormula = ~ (ndvi + precip + tmin + tdelta + wind)^2,
  #phyloTree = genus_tree_filter,
  studyDesign = studyDesign,
  ranLevels = list(sample = rL),
  distr = "probit"
...
VP2$vals %>%
  ...
  #mutate(var = factor(var, levels = c("ndvi", "precip", "tmin", "tdelta", "wind", "Random: sample"))) %>%
  pivot_longer(-var) %>%
  ggplot() +
...
partition = createPartition(m_converg, nfolds = 5, column = "sample")
#preds_pois = computePredictedValues(m_converg, partition = partition, thin = thin, nParallel = 14)


preds_expl = computePredictedValues(m_converg, thin = thin, nParallel = 14)
MF_expl = evaluateModelFit(hM = m_converg, predY = preds_expl) 
mean(MF_expl$RMSE)
#Predictive power based on cross-validation  
preds_pred =computePredictedValues(m_converg, partition = partition, thin = thin, nParallel = 14)
MF_pred = evaluateModelFit(hM = m_converg, predY = preds_pred)

#Predictive power based on conditional cross-validation 

partition.sp = c(rep(1,11),rep(2,11),rep(3,12))
preds_condi_pred = computePredictedValues(m_converg, partition = partition, partition.sp = partition.sp, thin = thin, nParallel = 14, mcmcStep = 100) 
MF_condi_pred = evaluateModelFit(hM = m_converg, predY = preds_condi_pred) 
str(preds_condi_pred)
mean(MF_condi_pred$RMSE)
...
mPredY_pois <- apply(abind::abind(preds_expl, along = 3), c(1, 2), matrixStats::mean2)
...
```{r}
occurence_mat <- mPredY_bin < 0.54	# No occurence if P < 0.53
model_perf_genus<- MF_bin$AUC < 0.65 # AUC < 0.5 is worse than random
...
```{r}
colnames(mPredY_pois) == colnames(Y_genus)
# mPredY_pois %>%
EpredY_hurdel %>%
    as.data.frame() %>%
    rownames_to_column("Sample_code") %>%
    pivot_longer(-Sample_code, names_to = "genus_names", values_to = "pred_abund") -> EpredY_long
colnames(Y_genus)
Y_genus %>%
  as.data.frame() %>%
  rownames_to_column("Sample_code") %>%
  pivot_longer(-Sample_code, names_to = "genus_names", values_to = "true_abund") -> test_samples_long

EpredY_long %>%
  left_join(test_samples_long, by = join_by(genus_names,Sample_code)) -> abund_test_df
...
table((abund_test_df$pred_abund == 0)[(abund_test_df$true_abund==0)])

abund_test_df %>%
 # filter(!(genus_names %in% c("Glomeraceae_gen11 (7 OTU)", "Funneliformis (2 OTU)"))) %>%
  ggplot()+
...
recap_df %>%
  arrange(desc(ratio_RMSE_sd)) %>%
  filter(ratio_RMSE_sd>100) %>% pull(genus_names)-> failed_genus
recap_df %>%
  ggplot() +
...
Y_genus %>% colnames
abund_test_df %>%
  left_join(covariate_standa_df%>%
              pivot_longer(-Sample_code, names_to = "covariates_names", values_to ="covariates_values"), by = "Sample_code",relationship = "many-to-many") -> abund_covar_df

abund_covar_df %>%
  filter(genus_names %in% c("Acaulospora (88 OTU)" ,"Nanoglomus (128 OTU)", "Dominikia (43 OTU)", "Viscospora (5 OTU)", "Microdominikia (11 OTU)", "Funneliformis (2 OTU)", "Silvaspora (10 OTU)")) %>%
  filter(!(true_abund ==0)) %>%
  ggplot()+
  geom_point(aes(covariates_values,true_abund)) +
  geom_smooth(aes(covariates_values,true_abund), formula =y ~ poly(x, 2), method = "glm") +
   geom_smooth(aes(covariates_values,true_abund), method = "glm", col ="forestgreen") +
  facet_grid(col = vars(covariates_names), row =vars(genus_names), scale = "free") +
  # scale_x_log10() +
  #scale_y_log10() +
  main_theme
```
...
recap_df %>%
  ...
  filter(ratio_RMSE_sd>100) %>% pull(genus_names)-> failed_genus
recap_df %>%
  filter(!(genus_names %in% failed_genus)) %>%
  ggplot() +
  geom_point(aes(genus_names, ratio_RMSE_sd))+
  scale_y_log10() +
  main_theme
